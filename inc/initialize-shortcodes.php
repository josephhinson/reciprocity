...
?>
						...
						foreach ($sections as $section) {
							...
							if	(!empty($todos)) { ?>
								...
								foreach ($todos as $todo) {
									echo '<li>
										<label for="item-'.$todo->post_name.'" data-id="'.$todo->ID.'">
        				...
        				<?php
            				...
            				foreach ($dones as $done) {
            					echo '<li><label for="item-'.$done->post_name.'" data-id="'.$done->ID.'"><input value="true" checked="checked" type="checkbox" id="item-'.$done->post_name.'"> '.$done->post_title.'</label>
